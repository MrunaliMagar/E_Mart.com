...
public class Invoice_detailsController 
{
	...
	@PostMapping
	public ResponseEntity<?> addInvoice_details(@RequestBody Invoice_details Invoice_details) {
	...
	public ResponseEntity<?> updateInvoice_details(@PathVariable int Invoice_detailsId,@RequestBody Invoice_details updatedInvoice_details) {
